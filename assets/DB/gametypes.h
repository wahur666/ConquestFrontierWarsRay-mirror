...
struct GT_TOOLBAR {
    ...
    struct COMMON {
        HOTBUTTON_DATA rotateLeft, returnDefaultView, rotateRight, minimize, restore, options, chat, go, starMap,
                exitSysMap,
    ...
    struct FABRICATOR {
        ...
        struct TAB1 {
            BUILDBUTTON_DATA plat0, plat1, plat2, plat3, plat4, plat5, plat6, plat7, plat8, plat9, plat10, plat11,
                    plat12, plat13, plat14, plat15;
        } basicTab;

        struct TAB2 {
            BUILDBUTTON_DATA plat16, plat17, plat18, plat19, plat20, plat21, plat22, plat23, plat24, plat25, plat26,
                    plat27, plat28, plat29, plat30, plat31;
        } advancedTab;

        struct TAB4 {
            BUILDBUTTON_DATA plat32, plat33, plat34, plat35, plat36, plat37, plat38, plat39, plat40, plat41, plat42,
                    plat43, plat44, plat45, plat46, plat47;
        } defenceTab;

        struct TAB5 {
            BUILDBUTTON_DATA plat48, plat49, plat50, plat51, plat52, plat53, plat54, plat55, plat56, plat57, plat58,
                    plat59, plat60, plat61, plat62, plat63;
        } moonTab;
    ...
    struct RESEARCH {
        ...
        RESEARCHBUTTON_DATA research0, research1, research2, research3, research4, research5, research6, research7,
                research8, research9;
        QUEUECONTROL_DATA buildQueue;
    ...
    struct BUILD_RES {
        ...
        STATIC_DATA hull, metalStorage, gasStorage, crewStorage, location, disabledText;
        RESEARCHBUTTON_DATA research0, research1, research2, research3, research4, research5, research6, research7,
                research8, research9, research10, research11, research12, research13, research14, research15;
    ...
    struct FLEET {
        ...
        struct TAB1 {
            ...
            MULTIHOTBUTTON_DATA specialOrders0, specialOrders1, specialOrders2, specialOrders3, specialOrders4,
                    specialOrders5, specialOrders6, specialOrders7,
                    specialOrders8, specialOrders9, specialOrders10, specialOrders11;
        } orderTab;

        struct TAB2 {
            SHIPSILBUTTON_DATA ship0, ship1, ship2, ship3, ship4, ship5, ship6, ship7, ship8, ship9, ship10, ship11,
                    ship12, ship13, ship14, ship15, ship16, ship17, ship18, ship19, ship20, ship21;
        } silTab;
    ...
    struct GROUP {
        ...
        HOTBUTTON_DATA fighterStanceNormal, fighterStancePatrol;
        SHIPSILBUTTON_DATA ship0, ship1, ship2, ship3, ship4, ship5, ship6, ship7, ship8, ship9, ship10, ship11, ship12,
                ship13, ship14, ship15, ship16, ship17, ship18, ship19, ship20, ship21;
    } group[4];
};
...
struct GT_ENDGAME {
    ...
    struct TAB3 {
        STATIC_DATA staticBuildingsTitles[6],
                    staticBuildingsMade[8],
                    staticBuildingsLost[8],
                    staticBuildingsDestroyed[8];
...
struct BASE_FLAGSHIP_SAVELOAD {
    ...
    enum AdmiralHotkey {
        NO_HOTKEY = 0, ADMIRAL_F1 = 1, ADMIRAL_F2, ADMRIAL_F3, ADMIRAL_F4, ADMIRAL_F5, ADMIRAL_F6
    } admiralHotkey;
};
...
struct GT_SPECIALABILITIES {
    SPECIALABILITYINFO none, assault, tempest, probe, cloak, aegis, vampire, stasis, furyram, repel, bomber, mimic,
            minelayer, s_minelayer,
            repulsor, synthesis, massdisruptor, destabilizer, wormhole, ping, m_ping, s_ping, multiCloak, tractor, jump,
            artilery, tractorWave, nova, shieldJam,
