...
using Raylib_cs;
using FrameworkTexture2D = ConquestFrontierWarsRay.Framework.Texture2D;
using TextureSlice = ConquestFrontierWarsRay.Framework.Texture2D.TextureSlice;
...
internal sealed class FakeTexture : FrameworkTexture2D {
