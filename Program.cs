...
internal static class Program
{
	public static void Main(string[] args)
	{
		...
		while (!Raylib.WindowShouldClose())
		{
			...
			Rectangle sourceRect = new(0, scrollY, previewTexture.Width, Math.Min(previewTexture.Height - scrollY, windowHeight - 128f));
			Rectangle destRect = new(16, 128, previewTexture.Width, sourceRect.Height);
