...
internal sealed class ShowcaseShellNode : Node {
	...
	protected override void OnInitialize() {
		_scenes.AddRange([
			...
			new SceneDefinition("Legacy Combobox", "Core.UI legacy combobox seam plus standalone Edit2 controls, with real GT data resolved through XmlDbRepository for editable text, prefix autocomplete, popup selection, and authored edit archetypes.", () => new LegacyComboboxScene()),
