...
public sealed class GT_OPTIONS {
	...
	public STATIC_DATA StaticSound { get; init; } = new();
	public STATIC_DATA StaticMusic { get; init; } = new();
	public STATIC_DATA StaticComm { get; init; } = new();
	public STATIC_DATA StaticChat { get; init; } = new();
	public STATIC_DATA StaticSpeed { get; init; } = new();
	public STATIC_DATA StaticScroll { get; init; } = new();
	public STATIC_DATA StaticMouse { get; init; } = new();
	public SLIDER_DATA SliderSound { get; init; } = new();
	public SLIDER_DATA SliderMusic { get; init; } = new();
	public SLIDER_DATA SliderComm { get; init; } = new();
	public SLIDER_DATA SliderChat { get; init; } = new();
	public SLIDER_DATA SliderSpeed { get; init; } = new();
	public SLIDER_DATA SliderScroll { get; init; } = new();
	public SLIDER_DATA SliderMouse { get; init; } = new();
	public BUTTON_DATA PushSound { get; init; } = new();
	public BUTTON_DATA PushMusic { get; init; } = new();
	public BUTTON_DATA PushComm { get; init; } = new();
	public BUTTON_DATA PushChat { get; init; } = new();
	public STATIC_DATA StaticDInput { get; init; } = new();
	public BUTTON_DATA PushDInput { get; init; } = new();
	public STATIC_DATA StaticStatus { get; init; } = new();
	public STATIC_DATA StaticRollover { get; init; } = new();
	public STATIC_DATA StaticSectorMap { get; init; } = new();
	public STATIC_DATA StaticRightClick { get; init; } = new();
	public STATIC_DATA StaticSubtitles { get; init; } = new();
	public BUTTON_DATA PushStatus { get; init; } = new();
	public BUTTON_DATA PushRollover { get; init; } = new();
	public BUTTON_DATA PushSectorMap { get; init; } = new();
	public BUTTON_DATA PushRightClick { get; init; } = new();
	public BUTTON_DATA PushSubtitles { get; init; } = new();
	...
	public STATIC_DATA StaticShips3D { get; init; } = new();
	public STATIC_DATA StaticTrails { get; init; } = new();
	public STATIC_DATA StaticEmissive { get; init; } = new();
	public STATIC_DATA StaticDetail { get; init; } = new();
	public STATIC_DATA StaticDrawBack { get; init; } = new();
	public BUTTON_DATA PushTrails { get; init; } = new();
	public BUTTON_DATA PushEmissive { get; init; } = new();
	public BUTTON_DATA PushDetail { get; init; } = new();
